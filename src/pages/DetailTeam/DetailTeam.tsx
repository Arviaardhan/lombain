  ...
  openRoles: [
    {
      ...
      skills: ["Figma", "Animation"],
      description: "Create micro-interactions",
    },
    {
      role: "UX Researcher",
      skills: ["User Testing"],
...
export default function DetailTeamPage() {
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8 min-h-screen bg-slate-50/20">
      ...
      <Link
        href="/explore"
        className="inline-flex items-center gap-2 text-[11px] font-black text-slate-400 hover:text-[#5A8D39] transition-all mb-6 tracking-widest"
      >
        ...
        <div className="grid gap-6 md:grid-cols-3 items-start">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
              <h2 className="text-[15px] font-bold mb-4 text-slate-900 uppercase tracking-tight">
                About Project
              </h2>
              <p className="text-slate-500 text-[13px] leading-relaxed whitespace-pre-line font-medium">
                {mockDetail.description}
              </p>
            </div>
            <DetailTeamStats
              wins={mockDetail.memberWins}
              achievements={mockDetail.achievements}
            />
          </div>
