    ...
    try {
      ...
      if (res.ok) {
        toast({
          ...
          description: "Informasi tim kamu sudah diperbarui.",
        });
        ...
        toast({
          variant: "destructive",
          title: "Gagal Update",
          description: result.message || "Periksa kembali inputan kamu.",
        });
      }
    } catch (error) {
      toast({
        ...
        >
          <header className="mb-10">
            ...
            <p className="text-slate-500 mt-2 font-medium">
              Perbarui headline dan detail kompetisi tim kamu.
            </p>
          </header>
          ...
          <div className="mt-12 flex flex-col md:flex-row items-center justify-between border-t pt-8 gap-6">
            <div className="flex items-center gap-3 text-amber-600 bg-amber-50 px-5 py-3 rounded-2xl text-xs font-semibold">
              ...
              <span>
                Info: Perubahan Role & Skill dapat dilakukan di tab "Team
                Structure".
              </span>
            </div>
