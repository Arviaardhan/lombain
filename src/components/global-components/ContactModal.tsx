...
export default function ContactModal({
  ...
  const waMessage = encodeURIComponent(
    `Halo ${user.name}, saya melihat profil Anda di Lombain.id dan tertarik untuk mengajak kolaborasi di tim saya. Apakah Anda memiliki waktu untuk berdiskusi?`,
  );

  const waUrl = `https://wa.me/${user.phone}?text=${waMessage}`;
  const mailUrl = `mailto:${user.email}?subject=${encodeURIComponent("Lombain.id - Kolaborasi Kompetisi")}`;
