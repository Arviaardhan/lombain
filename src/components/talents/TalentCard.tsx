...
import { Users, LayoutGrid, Github, Linkedin, ExternalLink } from "lucide-react";
    ...
    <div className="group bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full relative overflow-hidden">
      ...
      <div className="flex items-start justify-between mb-5 relative z-10">
        ...
        <div className="flex gap-2 text-slate-300 shrink-0 mt-1">
          {user.github_url && (
            <a href={user.github_url} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-900 transition-all hover:scale-110">
      ...
      <div className="flex flex-wrap gap-2 mb-6 min-h-[26px]">
        {skills.length > 0 ? (
          ...
          <span className="text-[10px] text-slate-300 italic font-medium">No skills listed</span>
        )}
        {skills.length > 3 && (
